                                ...
                                <div className="relative w-full max-w-md max-h-full">
                                    <div className="relative bg-gray-700 rounded-lg shadow ">
                                        ...
                                        <div className="p-6 text-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="mx-auto mb-4  w-12 h-12 text-green-600">
                                            ...
                                            <h3 className="mb-10 text-lg font-normal  text-gray-100">{results}</h3>
                                            <button onClick={handleContinue} type="button" className="text-white bg-green-600 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                                Continue
                                            </button>
                                        ...
                                        <div className={"relative bg-white border-4 rounded-lg shadow border-gray-500"}>
                                            ...
                                            <div className="p-6 text-center">
                                                {success ?
                                                    ...
                                                    </svg> : <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="mx-auto mb-4  w-12 h-12 text-red-600">
                                                ...
                                                <h3 className="mb-10 text-lg font-normal text-gray-800 ">{message}</h3>
                                                {success ? <button onClick={renderScanner} type="button" className="text-white bg-green-600 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                                    Scan New
                                                </button> : <button onClick={renderScanner} type="button" className="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">Scan Again</button>}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    <div className="relative w-full max-w-md max-h-full">
                                        <div className="relative bg-red-700 rounded-lg shadow ">
                                            <div className="p-6 text-center">
                                                <h3 className="text-xl font-normal text-gray-100 ">{message}</h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
